...
public class SpriteIndicator extends LinearLayout {
    ...
    public SpriteIndicator(Context context) {
        super(context);
        init(context, null);
    }

    public SpriteIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.SpriteIndicator);
        mIndicatorWidth =
                typedArray.getDimensionPixelSize(R.styleable.SpriteIndicator_si_width, -1);
        mIndicatorHeight =
                typedArray.getDimensionPixelSize(R.styleable.SpriteIndicator_si_height, -1);
        mIndicatorMargin =
                typedArray.getDimensionPixelSize(R.styleable.SpriteIndicator_si_margin, -1);

        mAnimatorResId = typedArray.getResourceId(R.styleable.SpriteIndicator_si_animator,
                R.animator.scale_with_alpha);
        mAnimatorReverseResId =
                typedArray.getResourceId(R.styleable.SpriteIndicator_si_animator_reverse, 0);
        mIndicatorBackgroundResId =
                typedArray.getResourceId(R.styleable.SpriteIndicator_si_drawable,
                        R.drawable.white_radius);
        mIndicatorUnselectedBackgroundResId =
                typedArray.getResourceId(R.styleable.SpriteIndicator_si_drawable_unselected,
                        mIndicatorBackgroundResId);
        typedArray.recycle();
    }
